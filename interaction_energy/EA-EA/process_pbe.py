...
def main():
    # --- 1. 定义文件路径 ---
    # 分子对能量文件
    dft_pair_path = './pbe_d3/DFT.ENERGY'
    dbmlff_pair_path = './dbmlff/DB.ENERGY'
    
    # 单分子能量文件（前100行和后100行分别使用）
    dft_single_path_1_100 = './pbe_d3/single_molecule_1_100/energy.txt'
    dft_single_path_101_200 = './pbe_d3/single_molecule_101_200/energy.txt'
