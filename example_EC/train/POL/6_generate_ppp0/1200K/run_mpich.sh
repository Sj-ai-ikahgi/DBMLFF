...
for cId in `seq 1 1500`
do
  echo ${cId}
  cp /data/home/xiongrui1/sabaisheng/Shenjie/fitting/EC/MLFF/MLFF_dataset/Conf_1200K/DFT_${cId}.config ./atom.config
