            ...
            do j12=1,num12
                ...
                if(ii_f.ne.0) then
                    ...
                    dfeat3(ii_f,itype12,iat,1,:)=dfeat3(ii_f,itype12,iat,1,:)+ &
                        ...
                        dfeat3_tmp(i1,j1,itype1,:)*temp7
                    if(idir.eq.1) then
                        dfeat3(ii_f,itype12,iat,jj11,:)=dfeat3(ii_f,itype12,iat,jj11,:)+ &
                            temp1(1)*ddx11_diat22(1,:)+ &
                            temp1(2)*ddx11_diat22(2,:)+ &
                            temp1(3)*ddx11_diat22(3,:)
                        dfeat3(ii_f,itype12,iat,jj22,:)=dfeat3(ii_f,itype12,iat,jj22,:)- &
                            temp1(1)*ddx11_diat22(1,:)- &
                            temp1(2)*ddx11_diat22(2,:)- &
                            temp1(3)*ddx11_diat22(3,:)
                    endif
                    if(idir.eq.2) then
                        dfeat3(ii_f,itype12,iat,jj33,:)=dfeat3(ii_f,itype12,iat,jj33,:)+ &
                            temp1(1)*ddx22_diat44(1,:)+ &
                            temp1(2)*ddx22_diat44(2,:)+ &
                            temp1(3)*ddx22_diat44(3,:)
                        dfeat3(ii_f,itype12,iat,jj44,:)=dfeat3(ii_f,itype12,iat,jj44,:)- &
                            temp1(1)*ddx22_diat44(1,:)- &
                            temp1(2)*ddx22_diat44(2,:)- &
                            temp1(3)*ddx22_diat44(3,:)
                    endif
