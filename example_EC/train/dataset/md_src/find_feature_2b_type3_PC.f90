subroutine find_feature_2b_type3_PC(natom, itype_atom, Rc, n2b, &
            num_neigh, list_neigh, &
            dR_neigh, iat_neigh, ntype, grid2_2, &
            feat_all, dfeat_all, nfeat0m, m_neigh, n2bm, nfeat_atom, neigh_cutoff)
      use mod_mpi
      implicit none
  ...
  5000    continue
          ...
          return
end subroutine find_feature_2b_type3_PC
