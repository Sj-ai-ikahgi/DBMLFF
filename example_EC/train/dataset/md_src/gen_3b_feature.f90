module calc_ftype2
    ...
    ! path for input directory which contains find_neighbore.in and IN.NEIGHBORE to be read
    ! Please set this variable before using this subroutine gen_feature_type2
    character(len=1000) path_3b
    
    character(len=20) str
    
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
contains
    subroutine load_model_type2(path)
        character(len=1000) path

        open(10,file=trim(path)//'/'//'input/gen_3b_feature.in',status="old",action="read")
        rewind (10)
        ...
        do kkk = 1, ntype    ! center atom
            ...
            if (iflag_grid .eq. 1 .or. iflag_grid .eq. 2) then
                ...
                open(10,file=trim(path)//'/'//'output/grid3b_cb12_type12.'//trim(str))
                rewind (10)
                do i = 0, n3b1 + 1
                ...
                open(10,file=trim(path)//'/'//'output/grid3b_b1b2_type12.'//trim(str))
                rewind (10)
                do i = 0, n3b2 + 1
            ...
            if (iflag_grid .eq. 3) then
                ...
                open(13,file=trim(path)//'/'//'output/grid3b_cb12_type3.'//trim(str))
                rewind (13)
                read (13, *) n3b1_t
                ...
                open(13,file=trim(path)//'/'//'output/grid3b_b1b2_type3.'//trim(str))
                rewind (13)
                read (13, *) n3b2_t
    ...
    subroutine gen_feature_type2(AL, xatom)
        ...
        call find_neighbore(iatom, natom, xatom, AL, Rc_type, num_neigh, list_neigh, &
            ...
            num_neigh_M,iat_neigh_M,path_3b)
