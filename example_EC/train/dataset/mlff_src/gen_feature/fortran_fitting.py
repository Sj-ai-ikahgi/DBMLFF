...
def writeFitInput():
    ...
    with open(pm.fitInputPath,'w') as fitInput:
        fitInput.write(str(len(pm.atomType))+', '+str(m_neigh)+', '+str(natoms)+', 1, 0, 1 '+\
                       '      ! ntype,m_neigh,natom_m, bond, vdw, pair\n')
        ...
        fitInput.write("4.0     ! dwidth for energy_group\n")               
        fitInput.write("6       ! system number\n")               
        fitInput.write("1.0     ! 300K_s\n")               
        fitInput.write("1.0     ! 600K\n")               
        fitInput.write("0.2     ! 500K_s\n")               
        fitInput.write("1.0     ! 1200K\n")               
        fitInput.write("0.02    ! 2000K_s\n")               
        fitInput.write("1.0     ! 300K\n")               
