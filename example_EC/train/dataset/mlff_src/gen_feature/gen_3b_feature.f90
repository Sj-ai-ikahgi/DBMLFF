...
1000 continue
    ...
    ! --------------------------------------------------------------------------------
    ! "(i5,',',i3,',',f12.7,',', i3,<nfeat0m>(',',f15.10))"
    ! The length of output is too short. When nfeat_atom(i) is large, it will be 
    ! printed as ***, and it causes problem when reading this file.
    ! So, we change this part to make it large enough.
    ! --------------------------------------------------------------------------------
