...
set_atom_type = 1
# atomType = list(range(1, 1+10))
# atomElement = ['O' for i in range(3)] + ['C' for i in range(4)] + ['H' for i in range(3)]

natoms = @natoms
atomTypeNum = @atomTypeNum
# O_TypeNum = @O_TypeNum
# C_TypeNum = @C_TypeNum
# H_TypeNum = @H_TypeNum
maxNeighborNum = @maxNeighborNum

atomType = list(range(1, 1+atomTypeNum))
# atomElement = ['O']*O_TypeNum + ['C']*C_TypeNum + ['H']*H_TypeNum
# atomElement = ['O']*atomTypeNum
atomElement = ['F']*8 + ['O'] + ['C']*5 + ['H']*4
...
fortranFitWeightOfEtot=2.0
fortranFitWeightOfForce=0.01
fortranFitRidgePenaltyTerm=0.00001
