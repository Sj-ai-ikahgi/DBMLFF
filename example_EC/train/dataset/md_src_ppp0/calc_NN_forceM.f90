...
!ccccccccccccccccccccccccccccccccccccccccccc
       ...
       call mpi_allreduce(energy_pred_tmp,energy_pred_NN,natom,MPI_REAL8,MPI_SUM,MPI_COMM_MOL,ierr)
       call mpi_allreduce(force_pred_tmp,force_pred_NN,3*natom,MPI_REAL8,MPI_SUM,MPI_COMM_MOL,ierr)
